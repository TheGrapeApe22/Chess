...
execute_process(
  COMMAND "/usr/bin/git" show-ref "3.0.x"
  WORKING_DIRECTORY "/mnt/c/Users/rohan/OneDrive/Documents/GitHub/Chess/chess/linux/_deps/sfml-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/c/Users/rohan/OneDrive/Documents/GitHub/Chess/chess/linux/_deps/sfml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/c/Users/rohan/OneDrive/Documents/GitHub/Chess/chess/linux/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
